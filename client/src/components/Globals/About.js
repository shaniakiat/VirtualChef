      ...
      <section>
        <div id="about" className="about">
          ...
          <p>
            ...
            <br /> <br />
            With no more indecision when looking for restaurants and struggling
            when you have minimal ingredients, this app allows you to make the
            most of what you have and give you new ideas you might not have had
            before.
          </p>
          {/* </div> */}
        </div>
